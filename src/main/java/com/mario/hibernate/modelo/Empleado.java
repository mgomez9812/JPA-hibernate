package com.mario.hibernate.modelo;
...
//@Table ->que la entidad se almancene en una tabla
//@Table(name="nombre_tabla") -> Si deseamo guardar esto en una tabla ya creada 
@Entity
@Table(name = "EMPLEADO")
